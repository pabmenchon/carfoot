$(document).ready(function(){
	...
	function getFactor(factor_data){
		...
		var factor			= factor_datas[1];
		return factor;
	}
		
	// table constructed wetland
	var bed1_total2_fuc = function(){
		var bed12		= $("input[name='bed12']").val();
		var btm_area	= $("input[name='btm_area']").val();
		var lifetime1	= $("input[name='lifetime1']").val();
		var bed1_type2	= getFactor($("select[name='bed1_type2']").find('option:selected').text());
		var sum			= Math.round(parseFloat(bed12) * parseFloat(btm_area) * parseFloat(lifetime1) * parseFloat(bed1_type2) / 10) / 100;
	...
	var bed2_total2_fuc = function(){
		var bed22		= $("input[name='bed22']").val();
		var lifetime1	= $("input[name='lifetime1']").val();
		var tonesCO2	= $("input[name='tonesCO2']").val();
	...
	var bed3_total2_fuc = function(){
		var bed32		= $("input[name='bed32']").val();
		var lifetime1	= $("input[name='lifetime1']").val();
		var total_area1	= $("input[name='total_area1']").val();
	...
	var tonesCO22_fuc = function(){
		var bed1_total2	= $("input[name='bed1_total2']").val();
		var bed2_total2	= $("input[name='bed2_total2']").val();
		var bed3_total2	= $("input[name='bed3_total2']").val();
		var sum = Math.round(parseFloat(bed1_total2) * parseFloat(bed2_total2) * parseFloat(bed3_total2) * 100) / 100;
	...
	var airpump_total3_fuc = function(){
		var airpump_num3		= $("input[name='airpump_num3']").val();
		var airpump_time3	= $("input[name='airpump_time3']").val();
		var airpump_src3	= getFactor($("select[name='airpump_src3']").find('option:selected').text());
		var sum = Math.round(parseFloat(airpump_num3) * parseFloat(airpump_time3) * parseFloat(airpump_src3) * 0.053 / 10) / 100;
	...
	var waterpump_total3_fuc = function(){
		var waterpump_num3		= $("input[name='waterpump_num3']").val();
		var waterpump_time3	= $("input[name='waterpump_time3']").val();
		var waterpump_src3	= getFactor($("select[name='waterpump_src3']").find('option:selected').text());
		var sum = Math.round(parseFloat(waterpump_num3) * parseFloat(waterpump_time3) * parseFloat(waterpump_src3) * 0.7 / 10) / 100;
	...
	var device1_total3_fuc = function(){
		var device1_num3		= $("input[name='device1_num3']").val();
		var device1_time3	= $("input[name='device1_time3']").val();
		var device1_comsuption3	= $("input[name='device1_comsuption3']").val();
		var device1_src3	= getFactor($("select[name='device1_src3']").find('option:selected').text());
		var sum = Math.round(parseFloat(device1_num3) * parseFloat(device1_time3) * parseFloat(device1_comsuption3) * parseFloat(device1_src3)/ 10) / 100;
	...
	var device2_total3_fuc = function(){
		var device2_num3		= $("input[name='device2_num3']").val();
		var device2_time3	= $("input[name='device2_time3']").val();
		var device2_comsuption3	= $("input[name='device2_comsuption3']").val();
		var device2_src3	= getFactor($("select[name='device2_src3']").find('option:selected').text());
		var sum = Math.round(parseFloat(device2_num3) * parseFloat(device2_time3) * parseFloat(device2_comsuption3) * parseFloat(device2_src3)/ 10) / 100;
	...
	var tonesCO23_fuc = function(){
		var airpump_total3		= $("input[name='airpump_total3']").val();
		var waterpump_total3	= $("input[name='waterpump_total3']").val();
		var device1_total3	= $("input[name='device1_total3']").val();
		var device2_total3	= getFactor($("select[name='device2_total3']").find('option:selected').text());
		var sum = Math.round(parseFloat(airpump_total3) * parseFloat(waterpump_total3) * parseFloat(device1_total3) * parseFloat(device2_total3)/ 100) / 100;
	...
	var removal_total4_fuc = function(){
		var removal_no4		= $("input[name='removal_no4']").val();
		var removal_time4	= $("input[name='removal_time4']").val();
	...
	var vegetation_total4_fuc = function(){
		var vegetation_no4		= $("input[name='vegetation_no4']").val();
		var vegetation_time4	= $("input[name='vegetation_time4']").val();
	...
	var travels_total4_fuc = function(){
		var travels_no4		= $("input[name='travels_no4']").val();
		var travels_time4	= $("input[name='travels_time4']").val();
	...
	var pipe1_total4_fuc = function(){
		var pipe14		= $("input[name='pipe14']").val();
	...
	var pipe2_total4_fuc = function(){
		var pipe24		= $("input[name='pipe24']").val();
	...
	var lightbulbs_total4_fuc = function(){
		var lightbulbs4		= $("input[name='lightbulbs4']").val();
	...
	var spotlight_total4_fuc = function(){
		var spotlight4		= $("input[name='spotlight4']").val();
	...
	var airpump_total4_fuc = function(){
		var airpump4		= $("input[name='airpump4']").val();
	...
	var waterpump_total4_fuc = function(){
		var waterpump4		= $("input[name='waterpump4']").val();
	...
	var tonesCO24_fuc = function(){
		var removal_total4		= $("input[name='removal_total4']").val();
		var vegetation_total4	= $("input[name='vegetation_total4']").val();
		var travels_total4		= $("input[name='travels_total4']").val();
		var pipe1_total4		= $("input[name='pipe1_total4']").val();
		var pipe2_total4		= $("input[name='pipe2_total4']").val();
		var manholes_total4		= $("input[name='manholes_total4']").val();
		var lightbulbs_total4	= $("input[name='lightbulbs_total4']").val();
		var spotlight_total4	= $("input[name='spotlight_total4']").val();
		var airpump_total4		= $("input[name='airpump_total4']").val();
		var waterpump_total4	= $("input[name='waterpump_total4']").val();
